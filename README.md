...
| **Prepared By**                    | Alejandro Galindo                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **Attendees to planning meeting**  | Galindo Montero, Alejandro Manuel; Perez Tuesta, Gabriel; Fajardo Monrroy, Walter Luis; Cumba Rengifo, Leonardo Raul; Cuentas Peña, Joaquin Alberto                                                                                                                                                                                                                                                                                                                                              |
| **Sprint 4 Review Summary**        | Durante este sprint mejoramos la plataforma haciéndola más funcional y realista. Agregamos gráficos que simulan datos de sensores IoT en el dashboard y permitimos que los técnicos suban fotos como evidencia en sus trabajos. También corregimos la conexión de datos para que cada usuario solo pueda ver sus propios locales y equipos. Además, mejoramos el diseño de las tarjetas y completamos las traducciones faltantes. |
| **Sprint 4 Retrospective Summary** | Notamos que las nuevas funciones (como los gráficos y la subida de fotos) necesitaron muchas correcciones menores sobre la marcha para funcionar bien. Para el futuro, aprendimos que debemos revisar mejor la calidad de nuestro código antes de juntarlo con el proyecto principal y planificar con más cuidado las tareas complicadas para evitar hacer el mismo trabajo dos veces.                                                                               |
| **Sprint Goal & User Stories**     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
